...
from aietorch.engine.mmseg.datasets.builder import build_dataloader
from ..trainer import Trainer
from ..exception import TrainerException
from .vars import DEFAULT_CFG
from aietorch.engine.mmseg.datasets import build_dataset
from aietorch.engine.mmseg.models import build_segmentor
from aietorch.engine.mmseg.apis import train_segmentor, single_gpu_test, multi_gpu_test, init_random_seed, set_random_seed
from aietorch.engine.mmseg.utils import (build_dp, build_ddp, collect_env, get_device, get_root_logger,
                         setup_multi_processes)
from aietorch.datasets.datasets import NonGeoDataset, DatasetType
from aietorch.cloud.model import AIEModel
...
class MMSegTrainer(Trainer):
    ...
    def get_onnx_script(self):
        package_base_dir = os.path.dirname(sys.modules["aietorch"].__file__)
