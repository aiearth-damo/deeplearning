import os
from aietorch.datasets.datasets import DatasetType
from aietorch.models.landcover.segmentors import EncoderDecoderLandcover
from aietorch.utils.pytorch2onnx.landcover import to_onnx
...
class LandcoverTrainer(MMSegTrainer):
    def __init__(self, work_dir="./workspace", config_name="fcn_hr18_1024x1024_16k_landcover") -> None:
