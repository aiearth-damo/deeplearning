...
from aietorch.engine.mmseg.ops import Upsample, resize
...
class ChangeSEHRNet(BaseModule):
    """HRNet backbone.
    ...
    Example:
        >>> from aietorch.engine.mmseg.models import HRNet
        >>> import torch
        >>> extra = dict(
        >>>     stage1=dict(
        >>>         num_modules=1,
    ...
    def __init__(
        ...
        super(ChangeSEHRNet, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        layer freezed."""
        super(ChangeSEHRNet, self).train(mode)
