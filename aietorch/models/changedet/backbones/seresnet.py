...
from aietorch.engine.mmseg.models.builder import BACKBONES
from aietorch.engine.mmseg.models.backbones.resnet import BasicBlock, Bottleneck
...
class SEBasicBlock(BasicBlock):
    ...
    def __init__(self, inplanes, planes, se_ratio=16, **kwargs):
        super(SEBasicBlock, self).__init__(inplanes, planes, **kwargs)
        self.se_layer = SELayer(planes, ratio=se_ratio)
...
class SEResLayer(Sequential):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(SEResLayer, self).__init__(*layers)
...
class SEResNet(BaseModule):
    ...
    Example:
        >>> from aietorch.engine.mmseg.models import ResNet
        >>> import torch
