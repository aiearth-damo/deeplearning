...
from aietorch.engine.mmseg.models.losses.utils import weight_reduce_loss
...
class CrossLabelLoss(nn.Module):
    """CrossLabelLoss.
    ...
    def __init__(
        ...
        super(CrossLabelLoss, self).__init__()
        ...
        if self.use_sigmoid:
            ...
            self.cls_criterion = cross_label
