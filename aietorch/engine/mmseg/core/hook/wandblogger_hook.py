...
from aietorch.engine.mmseg.core import DistEvalHook, EvalHook
...
class MMSegWandbHook(WandbLoggerHook):
    ...
    def before_run(self, runner):
        ...
        for hook in runner.hooks:
            ...
            if isinstance(hook, EvalHook):
                from aietorch.engine.mmseg.apis import single_gpu_test
                self.eval_hook = hook
                self.test_fn = single_gpu_test
            if isinstance(hook, DistEvalHook):
                from aietorch.engine.mmseg.apis import multi_gpu_test
                self.eval_hook = hook
    ...
    def _add_ground_truth(self, runner):
        ...
        from aietorch.engine.mmseg.datasets.pipelines import LoadImageFromFile
        img_loader = None
