from aietorch.engine.mmseg.datasets.pipelines.test_time_aug import MultiScaleFlipAug
...
class MultiScaleFlipAugRS(MultiScaleFlipAug):
    ...
    def __init__(self, transforms, rotate90=False, rotate_degree=0, **kwargs):
        ...
        self.rotate_degree = rotate_degree if isinstance(rotate_degree, list) else [rotate_degree]
