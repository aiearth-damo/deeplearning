...
from aietorch.engine.mmseg.core import eval_metrics, intersect_and_union
from aietorch.engine.mmseg.core.evaluation.metrics import total_area_to_metrics
from aietorch.engine.mmseg.datasets.builder import DATASETS
from aietorch.engine.mmseg.datasets.custom import CustomDataset
...
class ChangeDetDataset(CustomDataset):
    ...
    def pre_eval_to_metrics(
        ...
        """Modified from aietorch.engine.mmseg built-in."""
