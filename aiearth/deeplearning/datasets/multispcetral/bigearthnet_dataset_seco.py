...
class Bigearthnet(Dataset):
    ...
    def __init__(self, root, split, bands=None, transform=None, target_transform=None, download=False, use_new_labels=True, normalize=True):
        self.root = Path(root)
        self.split = split
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/mnt/user/E-qianwen.qian-350674/data/Bigearthnet/')
    parser.add_argument('--save_dir', type=str, default='/mnt/user/E-qianwen.qian-350674/data/Bigearthnet/dataload_op1_lmdb_uint8/')
