...
from aiearth.deeplearning.engine.mmseg.models.backbones.mit import EfficientMultiheadAttention
...
class GlobalSubsampledAttention(EfficientMultiheadAttention):
    ...
    which is a module from aiearth.deeplearning.engine.mmseg.models.backbones.mit.py.
